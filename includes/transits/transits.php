...
<div class="details">
	<h1>Detalle de tránsitos <small style="display:inline-block;">(S.E.U.O.)</small></h1>
	<h2><b>Nombre / Razón Social:</b> <?php echo esc_html( $client_name ); ?></h2>
	<h2><b>Nº de Cliente:</b> <?php echo esc_html( $client_data['nro_cliente'] ); ?></h2>
	<h2><b>Período:</b> <?php echo esc_html( $period ); ?></h2>
</div>
